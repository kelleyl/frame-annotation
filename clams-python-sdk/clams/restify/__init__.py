...
import clams.serialize as serialize
...
class Restifier(object):
    def __init__(self, app_instance):
        ...
        self.flask_app.config['SECRET_KEY'] = 'abcdefghijklmnop'
...
class ClamsRestfulApi(Resource):
    ...
    def post(self):
        return self.cla.sniff(serialize.Mmif(request.form['data']))

    def put(self):
        return self.cla.annotate(serialize.Mmif(request.form['data']))
